    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900">
      ...
      <section className="py-6 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300">
          <p>We collect minimal data to provide the service. Audio used in practice sessions is processed for feedback and is not shared with third parties. You can request deletion at any time by emailing privacy@omthentic.com.</p>
        </div>
      </section>
      <ModernFooter />
    </div>
