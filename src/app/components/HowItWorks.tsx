...
const HowItWorks = () => {
  ...
  return (
    <section id="how-it-works" className="py-20 lg:py-32 bg-gray-900 relative overflow-hidden">
      {/* Enhanced Background Pattern */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-20 left-20 w-72 h-72 bg-blue-500 rounded-full blur-3xl" />
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-purple-500 rounded-full blur-3xl" />
        <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-green-500 rounded-full blur-3xl" />
      </div>
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center space-y-4 lg:space-y-0 lg:space-x-8 mb-12">
            {steps.map((step, index) => (
              <React.Fragment key={step.id}>
                <motion.button
                  className={`flex items-center space-x-4 p-6 rounded-xl transition-all duration-300 border ${
                    activeStep === index
                      ? 'bg-white shadow-2xl border-primary/30 text-gray-900'
                      : 'bg-gray-800/80 backdrop-blur-sm hover:bg-gray-700/90 border-gray-600/50 text-white hover:shadow-xl hover:border-primary/30'
                  }`}
                  ...
                  viewport={{ once: true }}
                >
                  <div className={`w-16 h-16 rounded-lg bg-gradient-to-r ${step.color} flex items-center justify-center shadow-lg`}>
                    <step.icon className="w-8 h-8 text-white" />
                  </div>
                  <div className="text-left">
                    <div className={`text-sm font-medium ${activeStep === index ? 'text-gray-500' : 'text-gray-400'}`}>
                      {step.number}
                    </div>
                    <div className={`text-xl font-bold ${activeStep === index ? 'text-gray-900' : 'text-white'}`}>
                      {step.title}
                    </div>
                    <div className={`text-sm ${activeStep === index ? 'text-gray-600' : 'text-gray-300'}`}>
                      {step.subtitle}
                    </div>
                  </div>
                </motion.button>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                {steps[activeStep].features.map((feature, index) => (
                  <motion.div
                    key={feature}
                    className="flex items-center space-x-3 bg-gray-800/50 backdrop-blur-sm p-3 rounded-lg border border-gray-700/50"
              ...
              <motion.button
                className="bg-gradient-primary text-white px-8 py-4 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center space-x-3 group"
    ...
    <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-200/50">
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <h4 className="text-lg font-semibold text-gray-900">Practice Session</h4>
        ...
        <div className="flex items-center justify-between text-sm text-gray-700 bg-gray-50 p-4 rounded-lg">
          <span className="font-medium">Attempts: 1</span>
          <span className="font-medium">Best Score: --</span>
          <span className="font-medium">Time Limit: 2 min</span>
        </div>
      </div>
    </div>
  );
    ...
    <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-200/50">
      <div className="space-y-6">
        ...
        <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border border-purple-200">
          ...
          <div className="text-purple-600 font-semibold">Overall Score</div>
          <div className="text-sm text-purple-500 mt-1 font-medium">Great improvement!</div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center">
            ...
            <div className="text-sm text-green-600 font-medium">Clarity</div>
          </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-center">
            ...
            <div className="text-sm text-yellow-600 font-medium">Filler Words</div>
          </div>
          <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4 text-center">
            <div className="text-2xl font-bold text-indigo-700">Good</div>
            <div className="text-sm text-indigo-600 font-medium">Pace</div>
          </div>
        </div>
  ...
  return (
    <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-200/50">
      <div className="space-y-6">
        {/* Header */}
        <div className="flex items-center justify-between">
          <h4 className="text-lg font-semibold text-gray-900">Improvement Plan</h4>
          <div className="text-sm text-gray-600 bg-gray-100 px-3 py-1 rounded-full font-medium">
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-6">
          ...
          <div className="flex items-center justify-between">
            <div className="text-center">
              ...
              <div className="text-sm text-green-600 font-medium">First Attempt</div>
            </div>
            <ChevronRight className="w-6 h-6 text-green-500" />
            <div className="text-center">
              <div className="text-2xl font-bold text-green-700">85</div>
              <div className="text-sm text-green-600 font-medium">Latest Score</div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start space-x-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <div>
              <div className="text-sm font-semibold text-blue-900">Practice Power Pauses</div>
          ...
          <div className="flex items-start space-x-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
            ...
            <div>
              <div className="text-sm font-semibold text-yellow-900">Watch Example Response</div>
          ...
          <div className="flex items-start space-x-3 p-3 bg-purple-50 border border-purple-200 rounded-lg">
            ...
            <div>
              <div className="text-sm font-semibold text-purple-900">Practice Again</div>
