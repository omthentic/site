...
const CoreFeatures = () => {
  ...
  return (
    <section id="features" className="py-20 lg:py-32 bg-gray-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-purple-500 rounded-full blur-3xl opacity-20" />
      </div>
        ...
        >
            ...
            {features.map((feature, index) => (
              <motion.button
                ...
                className={`w-full text-left p-6 rounded-xl transition-all duration-300 border ${
                  activeFeature === index
                    ...
                    : 'bg-gray-800/60 backdrop-blur-sm hover:bg-gray-700/80 border-gray-700/50 text-white hover:shadow-xl hover:border-primary/20'
                }`}
              ...
              >
                <div className="flex items-center space-x-4 mb-3">
                  ...
                  <div>
                    <h3 className={`text-lg font-semibold ${activeFeature === index ? 'text-gray-900' : 'text-white'}`}>
                      {feature.title}
                    </h3>
                    <p className={`text-sm ${activeFeature === index ? 'text-gray-600' : 'text-gray-300'}`}>
                      {feature.subtitle}
                    </p>
                  </div>
                </div>
                <p className={`text-sm ${activeFeature === index ? 'text-gray-700' : 'text-gray-400'}`}>
                  {feature.description}
                </p>
              </motion.button>
            ))}
          ...
          <div className="lg:w-2/3">
            <AnimatePresence mode="wait">
              <motion.div
                key={activeFeature}
                className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-200/20 min-h-[400px]"
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-2xl font-bold text-gray-900">Live Analysis</h3>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border border-blue-200">
          ...
          <div className="text-sm text-blue-600 font-medium">Words/Min</div>
        </div>
        ...
        <div className="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-lg border border-green-200">
          ...
          <div className="text-sm text-green-600 font-medium">Pace</div>
        </div>
      </div>
...
const CharametricsWidget = () => {
  ...
  return (
    <div className="space-y-6">
      <h3 className="text-2xl font-bold text-gray-900 mb-6">Your Communication Strengths</h3>
...
const CoachWidget = () => {
  ...
  return (
    <div className="space-y-6">
      <h3 className="text-2xl font-bold text-gray-900 mb-6">Connect with Expert Coaches</h3>
      
      <div className="space-y-4">
        {coaches.map((coach, index) => (
          <motion.div
            key={coach.name}
            className="flex items-center justify-between p-6 bg-gradient-to-r from-gray-50 to-white border border-gray-200 rounded-xl hover:shadow-lg transition-all duration-300"
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-700 text-sm font-medium">{coach.role}</p>
            ...
            <div className="text-right">
              ...
              <p className="text-xs text-gray-600 mb-2">{coach.sessions} sessions</p>
              <motion.button
                className="px-4 py-2 bg-gradient-primary text-white text-xs rounded-lg font-medium shadow-md hover:shadow-lg transition-all duration-200"
