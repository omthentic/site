...
export default function RevampHome() {
  ...
  function prevSlide() {
    setActiveSlide((s) => (s - 1 + demoSlides.length) % demoSlides.length);
  }
  ...
  function computeMockFeedback(text: string, durationMs: number) {
    ...
    const fillerCount = words.reduce((acc, w, i) => acc + (fillers.includes(w) ? 1 : 0), 0);
    ...
    <main className="min-h-screen bg-background">
      ...
      <section id="widgets" className="py-14 sm:py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Carousel */}
          <div className="mt-8 rounded-2xl border border-subtle bg-card/60 backdrop-blur-sm p-4 sm:p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="text-sm text-secondary-body">
                {demoSlides[activeSlide].step}
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-6 items-center">
              <div>
                ...
                <div className="flex items-center gap-3">
                  <button
                    onClick={isRecording ? stopTryNow : startTryNow}
                  ...
                  <div className="rounded-xl border border-subtle bg-card p-5">
                    ...
                    <div className="grid grid-cols-3 gap-3 mb-4">
                      <div className="rounded-xl border border-subtle bg-background-primary p-4 text-center">
                        ...
                        <div className="text-h6">{feedback.clarity}%</div>
                      </div>
                      <div className="rounded-xl border border-subtle bg-background-primary p-4 text-center">
                        <div className="text-xs text-secondary-body">Filler Words</div>
                        <div className="text-h6">{feedback.filler}</div>
                      </div>
                      <div className="rounded-xl border border-subtle bg-background-primary p-4 text-center">
                        <div className="text-xs text-secondary-body">Confidence</div>
                        <div className="text-h6">{feedback.confidence}</div>
                      </div>
                    </div>
                    {transcript && (
